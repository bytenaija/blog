...
app.get("/uploads/:uuid/:name", onGetImage)

function onGetImage(req, res) {
    const {uuid, name} = req.params
 res.sendFile(__dirname + `/uploads/${uuid}/${name}`);
                              }
...
function moveUploadedFile(file, uuid, success, failure) {
   const  ext = path.extname(file.originalFilename);
    var destinationDir = uploadedFilesPath + uuid + "/",
      fileDestination = destinationDir + uuid ;
...
function combineChunks(file, uuid, success, failure) {
   const ext = path.extname(file.originalFilename);
    ...
    var chunksDir = uploadedFilesPath + uuid + "/" + chunkDirName + "/",
      ...
      fileDestination = destinationDir + uuid+ext;
